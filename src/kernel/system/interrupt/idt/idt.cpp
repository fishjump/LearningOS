...
system::interrupt::idt::IdtDescriptor system::interrupt::idt::idtTable[system::interrupt::idt::MAX_INT_NUMBER] = {0};
const system::interrupt::idt::IdtTableDescriptor system::interrupt::idt::idtTableDescriptor = {sizeof(system::interrupt::idt::idtTable) * 8 - 1, (uint64_t)system::interrupt::idt::idtTable};
